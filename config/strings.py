...
ABOUT_TEXT = (
        ...
        "• <i>Advanced Logging</i>: High-performance project logging via <b>Loguru</b>.\n"
...
COMMANDS_TEXT = (
        ...
        "• /mute_list <code>[count]</code> - View history of mutes.\n"
        "• /ban_list <code>[count]</code> - View history of bans.\n\n"
        "<b>User Commands:</b>\n"
